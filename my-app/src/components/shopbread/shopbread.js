...
class Shopbread extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      orderedBread: [],
      ...
      return (
        ...
        >
          <p className="order">
            ...
            >
              <FaPlus className="edit-bread"></FaPlus>
            </Button>
            {item.count}
            <Button
            ...
            >
              <FaMinus className="edit-bread"></FaMinus>
            </Button>
            <Button
              className="bread-action-button"
              onClick={async () => {
            ...
            >
              <FaTrash className="edit-bread"></FaTrash>
            </Button>
          </p>
        </Container>
      );
      ...
      <Row>
        ...
        <Col id="col2" sm={12} md={8} lg={6}>
          <h1 className="shop-title">
            Breads <span className="title">Offered</span>
          </h1>
          <p>
